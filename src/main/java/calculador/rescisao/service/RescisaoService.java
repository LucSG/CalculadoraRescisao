...
public class RescisaoService {
    ...
    public RescisaoResponse calcularRescisao(RescisaoRequest request) {
        ...
        response.setTotalBruto(BigDecimal.valueOf(VerificadoresService.quantidadeMeses(request)));//verificando...
        ...
        BigDecimal totalLiquido = BigDecimal.ONE;//bruto-descontos
