...
public class RescisaoService {
    ...
    public RescisaoResponse calcularRescisao(RescisaoRequest request) {
        ...
        long mesesTrabalhadosNoAno = ChronoUnit.MONTHS.between(request.getDataDesligamento().withDayOfMonth(1).withMonth(1), request.getDataDesligamento().withDayOfMonth(1)) + 1;
        ...
        response.setInss(BigDecimal.ZERO); // TODO: Implementar cálculo do INSS
        response.setIrrf(BigDecimal.ZERO); // TODO: Implementar cálculo do IRRF
